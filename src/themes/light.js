...
const lightTheme = {
  ...
  gray: "#4FC8D9",
  blueish_gray: "#4FC8D9",
  textHighlightColor: "#4FC8D9", // "#F4D092",
  ...
  background: "linear-gradient(180deg, #4FC8D9 0%, rgba(184, 212, 216, 0.5) 100%)",
  ...
  activeLinkColor: "#4FC8D9",
  activeLinkSvgColor: "invert(64%) sepia(11%) saturate(934%) hue-rotate(157deg) brightness(90%) contrast(86%)",
  // primaryButtonBG: "#759AAE",
  primaryButtonBG: "#4FC8D9",
  primaryButtonHoverBG: "#000000",
  // these need fixing
  primaryButtonHoverColor: "#4FC8D9",
  secondaryButtonHoverBG: "#4FC8D9",
  outlinedPrimaryButtonHoverBG: "#4FC8D9",
  outlinedPrimaryButtonHoverColor: "#333333",
  outlinedSecondaryButtonHoverBG: "#4FC8D9",
